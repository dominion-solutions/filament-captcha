...
namespace DominionSolutions\FilamentCaptcha\Tests;
...
class TestCase extends Orchestra
{
    protected function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(
            fn (string $modelName) => 'DominionSolutions\\FilamentCaptcha\\Database\\Factories\\' . class_basename($modelName) . 'Factory'
        );
    }
